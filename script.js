    ...
    */
    ...
    if (orcamentoForm) {
        orcamentoForm.addEventListener('submit', function(e) {
            ...
            // Formata a mensagem usando %0A para quebras de linha que o WhatsApp entende
            const quebraLinha = '%0A';
            
            // Usa a formatação com quebraLinha
            ...
            mensagem += `A foto de referência deve ser enviada após esta mensagem.`; // Ajustei a frase final

            // Codifica a mensagem UMA ÚNICA VEZ para a URL
            const urlMensagem = encodeURIComponent(mensagem);

            // Monta a URL do WhatsApp Web/Mobile
